...
| Skill | Description |
|-------|-------------|
| [project-standards](project-standards-skill/) | Audit a project against project standards (docs, .gitignore, Justfile, CI workflows, GitHub settings, security, branch rules, labels) and fix gaps |
